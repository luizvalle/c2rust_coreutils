    ...
    's_25: loop {
        ...
        match quoting_style as libc::c_uint {
            6 => {
                ...
                current_block_48 = 1752605773408826991;
            }
            5 => {
                current_block_48 = 1752605773408826991;
            }
            ...
            3 => {
                backslash_escapes = 1 as libc::c_int != 0;
                current_block_48 = 3023463617567964315;
            }
            1 => {
                current_block_48 = 3023463617567964315;
            }
            4 => {
                current_block_48 = 12200064328057794513;
            }
            2 => {
                current_block_48 = 10255622956629795657;
            }
            0 => {
                elide_outer_quotes = 0 as libc::c_int != 0;
                current_block_48 = 2989495919056355252;
        ...
        } == 0
        {
            ...
            {
                if elide_outer_quotes {
                    current_block = 3687325084878354090;
                    break 's_25;
                }
            ...
            match c as libc::c_int {
                ...
                63 => {
                    match quoting_style as libc::c_uint {
                        2 => {
                            current_block = 139255840664946815;
                            match current_block {
                                139255840664946815 => {
                                    if elide_outer_quotes {
                                        current_block = 3687325084878354090;
                        ...
                        5 => {
                            current_block = 13534938107135860449;
                            match current_block {
                                139255840664946815 => {
                                    if elide_outer_quotes {
                                        current_block = 3687325084878354090;
                ...
                7 => {
                    ...
                    current_block = 10326144810149266599;
                }
                8 => {
                ...
                10 => {
                    ...
                    current_block = 7208529569300479952;
                }
                13 => {
                ...
                92 => {
                        ...
                        == shell_always_quoting_style as libc::c_int as libc::c_uint
                    {
                        ...
                        current_block = 9268536821488149262;
                ...
                123 | 125 => {
                    ...
                    } == 0
                    {
                        ...
                        current_block = 16542726660071227281;
                    }
                }
                35 | 126 => {
                    current_block = 16542726660071227281;
                ...
                32 => {
                    current_block = 18037386337399018045;
                }
                33 => {
                    current_block = 14008594173364196201;
                }
                34 | 36 | 38 | 40 | 41 | 42 | 59 | 60 | 61 => {
                    current_block = 9097953857718518436;
                }
                62 | 91 | 94 => {
                    current_block = 3673019761254966263;
                }
                96 | 124 => {
